...
export MARIADB_GALERA_CONF_DIR="${MARIADB_GALERA_CONF_DIR:-/opt/canonical/mariadb-galera/conf}"
export DB_GALERA_CONF_DIR="$MARIADB_GALERA_CONF_DIR"
export MARIADB_GALERA_MOUNTED_CONF_DIR="${MARIADB_GALERA_MOUNTED_CONF_DIR:-/canonical/conf}"
